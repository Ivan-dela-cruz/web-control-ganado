    ...
    <div>
        <table id="facvendedor">
            ...
            <tr id="headerOrden">
                ...
                <th class="tdOrdenDetalle">Total litros</th>
            </tr>
            </thead>
            <tbody>
            <tr id="datoOrden">
                <td class="tdOrdenDetalle">{{$income->id}}</td>
                <td class="tdOrdenDetalle">{{\Carbon\Carbon::parse($income->created_at)->format('Y-m-d') }}</td>
    ...
    <div>
        <table id="facarticulo">
            ...
            <tr style="color: black; text-align: center; background-color: white;">
                <th class="tdOrdenDetalle" style="text-align: center;" colspan="5">Detalle del ordeños</th>
            </tr>
            <tr style="text-align: left;" id="fa">
                <th class="tdOrdenDetalle" width="10px">N°</th>
                <th class="tdOrdenDetalle">Animal</th>
                <th width="120px" class="tdOrdenDetalle">Litros</th>
                <th class="tdOrdenDetalle">Hora</th>
