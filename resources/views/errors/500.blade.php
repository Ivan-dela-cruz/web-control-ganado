        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="text-center">
                    <img src="{{asset('assets2/images/maintance/maintance.png')}}" alt="" class="img-fluid">
                    <h5 class="text-muted my-4">Lo siento! Ocurrio un error comunicate con el administrador!</h5>
